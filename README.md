...
* src/ contains all .py files of this repository
    ...
    * ES_numba.py measures the event synchronization of the extreme event time series in parallel via mpi4py and it is written to run on a high performance cluster with the script SlurmParallelES.sh using the workload manager SLURM
